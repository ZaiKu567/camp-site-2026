...
const days = [
    ...
    },
    {
        ...
        sessions: [
            ...
            { time: '', tag: '', tagClass: '', title: '午餐時間', desc: '', detail: '' },
            { time: '13:10–16:10', tag: '下午', tagClass: 'tag-afternoon', title: '主題課程二', desc: '讓網頁動起來 ——<br>用 JavaScript 開發互動式小應用', detail: '還記得 2021 風靡世界的 pop cat 嗎，<br>
雖然我們會架網站了，但要怎麼樣才能讓自己的網頁動起來呢？<br>
在這堂課程中，將透過實際操作程式語言，讓你的網頁動起來！<br>
<br>
📌 課程內容
1. 程式語言基礎 —— JavaScript 基礎語法（變數、條件判斷、迴圈等...）<br>
2. 親手感受程式語言 —— 透過小任務實際運用上述語法<br>
3. 讓網頁動起來 —— JavaScript DOM 介紹與使用<br>
<br>
🥸☝️ 這堂課中我們將學到<br>
1. JavaScript 程式語言的語法<br>
2. 如何打造可互動的網頁<br>
3. 製作自己的 Bongo Cat！<br>
<br>
在這個科技更迭的時代，學會一個程式語言絕對不吃虧！<br>
趕快來跟我們一起探索前端的世界吧！' },
